...
import com.example.content_provider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.example.content_provider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.example.content_provider.database.NotesProvider.Companion.URI_NOTES
...
class NotesDetailFragment : DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(activity as Activity)
            .setTitle(if (newNote) "Digita tua mensagem" else "Edita tua mensagem")
            .setView(view)
